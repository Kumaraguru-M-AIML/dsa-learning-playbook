...
> **Status:** Active Operational Reference | **Version:** 5.5 (Deep Usability Upgrade) | **Author:** Aria System Governor & Antigravity
...
graph TD
    %% Styling
    classDef system fill:#12131C,stroke:#3b82f6,stroke-width:1px,color:#fff;
    classDef protocols fill:#111827,stroke:#10b981,stroke-width:1px,color:#fff;
    classDef roadmaps fill:#1E1B4B,stroke:#6366f1,stroke-width:1px,color:#fff;
    classDef knowledge fill:#171123,stroke:#a855f7,stroke-width:1px,color:#fff;
    classDef records fill:#1D1913,stroke:#f59e0b,stroke-width:1px,color:#fff;

    %% Nodes
    CC["01_SYSTEM<br>(Core Operating Rules, Blueprints, Indices)"]:::system
    PR["02_PROTOCOLS<br>(Dimension Manuals, Daily Active Plans)"]:::protocols
    RM["03_ROADMAPS<br>(Phase Blueprints, USM Memory Wiki Hub)"]:::roadmaps
    KN["04_KNOWLEDGE<br>(92 Book Summaries, Advanced Mastery Deep Dives)"]:::knowledge
    RE["05_RECORDS<br>(Progress Journal, Mastery Templates)"]:::records

    %% Funnel Connections
    KN -->|FORGE Funnel Extraction| RM
    RM -->|Phase Allocation & Schedule| PR
    PR -->|Daily Operational Execution| RE
    RE -->|Weekly Sync Logs| CC
```
...
---
*Dossier successfully expanded and upgraded under ARIA System Rules v5.5 | All Paths Synchronized | Operational Ledger Standing By.*
